...
pygame.display.set_caption("Metrius Eats - Customer 2 Animation")
...
walk3 = pygame.image.load(
    "walk_3.png"
).convert_alpha()

walk4 = pygame.image.load(
    "walk_4.png"
).convert_alpha()
...
# Images are NEVER stretched to these dimensions.
# Their original aspect ratio is preserved.
#
# ============================================================
...
def fit_sprite(image, size_multiplier=1.0):
    """
    Fit the image inside the display size while preserving
    ...
    # Choose the smaller scale so the complete image fits
    scale = min(width_scale, height_scale)

    # Apply requested size multiplier
...
# BLINK LOOP
#
# still -> intermediate -> closed -> intermediate -> still
# ------------------------------------------------------------
...
while running:
    ...
    current_blink_sprite = BLINK_FRAMES[blink_frame]
    ...
    current_walk_sprite = WALK_FRAMES[walk_frame]
